 ...
 *
 * 实验规模：
 * - 快速验证：8算法 × 3函数 × 5次 = 120次测试（~10分钟）
 * - 完整实验：8算法 × 30函数 × 30次 = 7200次测试（~18-24小时）
 *
 * 输出格式：
...
public class BenchmarkCompareExample {
    ...
    public static void runQuickTest() {
        ...
        System.out.println("  - 总测试量：8 × 3 × " + QUICK_NUM_RUNS + " = " + (8 * 3 * QUICK_NUM_RUNS) + " 次\n");
    ...
    public static void runFullExperiment() {
        ...
        System.out.println("  - 迭代次数：" + MAX_ITERATIONS);
        System.out.println("  - 总测试量：8 × 30 × " + NUM_RUNS + " = " + (8 * 30 * NUM_RUNS) + " 次");
        System.out.println("  - 预计用时：18-24 小时\n");
